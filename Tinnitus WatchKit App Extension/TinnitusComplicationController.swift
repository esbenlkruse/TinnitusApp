...
/**
 The `TinnitusComplicationController` is responsible for communicating between
 ...
 */
class TinnitusComplicationController: NSObject, CLKComplicationDataSource, CLLocationManagerDelegate {
